  ...
  if ($userEmail == $email && $userPass == $password)
   {
    ...
    echo "<script> alert('invallid')</script>";
...
<!--               <hr class="my-4">
 -->              <button class="btn btn-lg btn-primary btn-block text-uppercase " style="background-color: #ff0000" 
                      type="submit" name="sub"> <a href="register.php">Create an Account</a></button>
            </form>
            <a href=""></a>
          </div>
        </div>
